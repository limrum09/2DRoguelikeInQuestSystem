...
namespace Completed
{
	...
	public class GameManager : MonoBehaviour
	{
		...
		private  bool arrowKeysEnable;
		public bool ArrowKeysEnable
        {
			get => arrowKeysEnable;
			set => arrowKeysEnable = value;
        }
		...
		void InitGame()
		{
			...
			levelImage = GameObject.FindGameObjectWithTag("LevelImage").GetComponent<Image>();
